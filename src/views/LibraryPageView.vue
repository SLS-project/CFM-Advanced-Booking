<template>
    <div class="LibraryPageView">
                ...
                <b-col class="col" id="catalogue" >
                    <b-breadcrumb >
                        <b-breadcrumb-item href="#home">
                            ...
                            </svg> HOME</b-breadcrumb-item>
                        <b-breadcrumb-item>SELECT LOCATION</b-breadcrumb-item>
                        <b-breadcrumb-item active>DATE/TIME CHOOSE </b-breadcrumb-item>
                        <b-breadcrumb-item active><i class="bi bi-chevron-right"></i>WORKSTATION GROUP</b-breadcrumb-item>
                        <b-breadcrumb-item active><i class="bi bi-chevron-right"></i>BOOKING DETAILS</b-breadcrumb-item>
                        <b-breadcrumb-item active><i class="bi bi-chevron-right"></i>BOOKING CONFIRMATION</b-breadcrumb-item>
                    </b-breadcrumb>
                </b-col>
            </b-row>
        </b-container>
        ...
        <b-container id="containerMobile2">
            <div class="containerbutton">
                <div>
                    <input id="conditionOfUse" type="checkbox" class="checkedboxstyle"
                        v-on:click="agreeToConditionOfUse()">
                    I agree to the <br />
